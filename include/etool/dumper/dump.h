...
namespace etool { namespace dumper {
    ...
    struct info {
        ...
        static void getx(ui8 c, char* res)
        {
        ...
        static void get_(char* res)
        {
            res[0] = res[1] = '-';
        }

        static bool printable(ui8 c)
        {
            return (c >= 32) && (c <= 126);
        }

        static void copy_data(const char* input, size_t len, char* output)
        {
        ...
        static size_t buffer_size(size_t len)
        {
    ...
    struct ui16_to_hex {
        ...
        static void getx(ui16 c, char* res)
        {
    ...
    struct ui32_to_hex {
        ...
        static void getx(ui32 c, char* res)
        {
    ...
    struct ui64_to_hex {
        ...
        static void getx(ui64 c, char* res)
        {
    ...
    struct make {
        ...
        static void line(uint32_t id, const char* input, size_t len,
                         char* output)
        {
        ...
        static void all(const void* input, size_t len, char* output)
        {
        ...
        static StreamType& all(const void* input, size_t len, StreamType& os)
        {
            const char* inp = static_cast<const char*>(input);
            for (size_t id = 0; id < len; id += info::elements) {
                if (id) {
        ...
        static std::string to_hex(const void* input, size_t len,
                                  std::string postfix = "",
                                  std::string prefix = "")
        {
