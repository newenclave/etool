...
namespace etool { namespace console { namespace ccout {
    ...
    struct color_map {
        static unsigned get(std::size_t id)
        {
            static const unsigned val[]
                = { LightGrey, LightRed, LightGreen, LightBlue,
                    Yellow,    White,    Cyan };
            return val[id];
        }
    ...
    struct color_map {
        static const char* get(std::size_t id)
        {
            ...
            static const char* val[] = { cp_none,   cp_red,   cp_green, cp_blue,
    ...
    inline std::ostream& set_stream_color(std::ostream& s, unsigned color)
    {
    ...
    inline std::ostream& light(std::ostream& s)
    {
    ...
    inline std::ostream& none(std::ostream& s)
    {
