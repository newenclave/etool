...
namespace etool { namespace details {
    ...
    namespace traits {
        ...
        struct value {
            ...
            static void copy(value_type& v, const value_type& from)
            {
                v = from;
            }
            ...
            static value_type&& move(value_type& v)
            {
                return std::move(v);
            }

            static value_type& get(value_type& v)
            {
                return v;
            }

            static const value_type& get(value_type const& v)
            {
                return v;
            }
        };
        ...
        struct shared_ptr {
            ...
            static const T& get(value_type const& v)
            {
                return *v;
            }
        };
    ...
    template <typename T, typename E, typename Trait = traits::value<T>>
    class result {
    ...
    inline std::ostream& operator<<(std::ostream& o, const result<T, E>& res)
    {
        if (res) {
            o << "Ok: " << *res;
        } else {
